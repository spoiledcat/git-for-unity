...
namespace Unity.VersionControl.Git.ICSharpCode.SharpZipLib.Zip
{
	/// <summary>
	...
	public class ZipEntry : IArchiveEntry
	{
		...
		/// </returns>
		/// <see cref="Unity.VersionControl.Git.ICSharpCode.SharpZipLib.Zip.CompressionMethod.Deflated"/>
		/// <see cref="Unity.VersionControl.Git.ICSharpCode.SharpZipLib.Zip.CompressionMethod.Stored"/>
