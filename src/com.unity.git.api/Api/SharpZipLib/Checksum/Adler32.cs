...
namespace Unity.VersionControl.Git.ICSharpCode.SharpZipLib.Checksum
{
	/// <summary>
	...
	///    checksum of zero.)"
	/// </summary>
	/// <see cref="Unity.VersionControl.Git.ICSharpCode.SharpZipLib.Zip.Compression.Streams.InflaterInputStream"/>
	/// <see cref="Unity.VersionControl.Git.ICSharpCode.SharpZipLib.Zip.Compression.Streams.DeflaterOutputStream"/>
