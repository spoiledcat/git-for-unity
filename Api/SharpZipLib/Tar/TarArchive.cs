...
namespace Unity.VersionControl.Git.ICSharpCode.SharpZipLib.Tar
{
	/// <summary>
	...
	public class TarArchive : IEnumerable, IDisposable, IArchive
	{
		...
		public void ExtractAndTranslateEntry(string destFile, Stream outputStream)
		{
            ...
            {
#if NET35
                var ctor = typeof(StreamWriter).GetConstructor(BindingFlags.NonPublic, null,
                    new Type[] { typeof(Stream), typeof(Encoding), typeof(int), typeof(bool) }, null);
                using (var outw = (StreamWriter)ctor.Invoke(new object[] { outputStream, new UTF8Encoding(false), 1024, true }))
#else
