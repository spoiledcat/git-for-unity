...
namespace Unity.VersionControl.Git.ICSharpCode.SharpZipLib.Zip.Compression.Streams
{
	/// <summary>
	...
	/// as the <see cref="Unity.VersionControl.Git.ICSharpCode.SharpZipLib.GZip.GZipInputStream">GZipInputStream</see>.
	///
